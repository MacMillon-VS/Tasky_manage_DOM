    ...
    <div class="card">
      <div class="card-header gap-2 d-flex justify-content-end">
        ...
        <button
          ...
          <i class="fas far fa-trash-alt" id=${taskData.id} onclick="deleteCard.apply(this, arguments)"></i>
        </button>
      </div>
      ...
      <div class="card-footer text-muted">
        <button class="btn btn-outline-primary  id=${taskData.id} ">Open Task</button>
      </div>
    </div>
  </div>
`;
